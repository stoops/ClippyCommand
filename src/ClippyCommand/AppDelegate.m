...
- (void)windowDidResize:(NSNotification *)aNotification {
    ...
    for (int x = 0; x < [buttonsl count]; ++x) {
        ...
        [text setFrameSize:NSMakeSize(self.cmdscoln.width - 20, 22)];
    }
}
...
- (void)menuBar:(NSNotification *)aNotification {
    ...
    [menubar.button.menu popUpMenuPositioningItem:nil atLocation:NSMakePoint(posi.x, posi.y+8) inView:nil];
}
